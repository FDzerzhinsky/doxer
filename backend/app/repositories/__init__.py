"""
EN: File: app/repositories/__init__.py
EN: Purpose: Defines package initialization and shared exports.
...
RU: Файл: app/repositories/__init__.py
RU: Назначение: Определяет инициализацию пакета и общие экспортируемые сущности.
...
"""Persistence adapters for document metadata."""
